...
log_level = 'INFO'
load_from = "/home/user/2d/mmdetection/checkpoints/faster_rcnn_r50_fpn_1x_voc0712_20220320_192712-54bef0f3.pth"
resume = False
...
test_dataloader = dict(
    ...
    sampler=dict(type='DefaultSampler', shuffle=False),
    dataset=dict(
        img_subdir="voc_yolov8m_attacked",
        type=dataset_type,
        data_root=data_root,
...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            roi_feat_size=7,
            num_classes=20,     # PASCAL VOC có 20 classes
            bbox_coder=dict(
                type='DeltaXYWHBBoxCoder',
                target_means=[0., 0., 0., 0.],
    ...
    test_cfg=dict(
        rpn=dict(
            ...
            min_bbox_size=0),
        rcnn=dict(
            score_thr=0.5,     # thay đổi threshold khi cần
